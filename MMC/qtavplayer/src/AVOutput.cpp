...
void AVRenderer::init(){
    ...
    if (!m_program) {
        ...
        m_program->addShaderFromSourceFile(QOpenGLShader::Vertex,":/Plug/video.vert");
        m_program->addShaderFromSourceFile(QOpenGLShader::Fragment,params.isPlanar ? ":/Plug/planar.frag" : ":/Plug/packed.frag");
...
void AVOutput::registerPlugin()
{
    qmlRegisterType<AVDefine>("qtavplayer", 1, 0, "AVDefine");
    qmlRegisterType<PlayVideo>("qtavplayer", 1, 0, "AVPlayer");
